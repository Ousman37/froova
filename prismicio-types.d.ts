...
/**
 * Default variation for BigMessage Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigMessageSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  never
>;
...
/**
 * Slice variation for *BigMessage*
 */
type BigMessageSliceVariation = BigMessageSliceDefault;

/**
 * BigMessage Shared Slice
 *
 * - **API ID**: `big_message`
 * - **Description**: BigMessage
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigMessageSlice = prismic.SharedSlice<
  "big_message",
  BigMessageSliceVariation
>;
...
export interface CarouselSliceDefaultPrimary {
  ...
  /**
   * flavor_cos field in *Carousel → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: carousel.default.primary.flavor_cos
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  flavor_cos: prismic.RichTextField;

  /**
   * choose_pricing_option field in *Carousel → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: carousel.default.primary.choose_pricing_option
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  choose_pricing_option: prismic.SelectField<
    "12 Cans - $35.99" | "24 Cans - $65.99" | "Subscription (Monthly) - $32.99"
  >;
}
